...
window.onkeydown = function(e) {keys[e.keyCode]=true; if(keys[32]) window.location.reload();}
...
linkAction('control_left', 'break', 'break');
linkAction('control_right', 'jump', 'left');